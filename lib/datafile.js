...
_.extend(Reader.prototype, {
    ...
    _readHeader: function() {
        ...
        this.decoder.writersSchema = this.writersSchema;
    ...
    _readBlock: function(final) {
        ...
        if (block && block.objects) {
            ...
            if (block.sync.toString() !== this.syncMarker.toString()) {
                console.log("going back %d", this.SYNC_SIZE);
    ...
    write: function(newBuffer) {
        ...
        if (this._streamOffset === 0) {
            ...
            while (this._fileBlock.remainingBytes > SYNC_SIZE * 1000 && this._readBlock()) {}
        }
        return !this._paused;
    },
...
_.extend(Writer.prototype, {
    ...
    _writeHeader: function(schema) {
        ...
        var headerSize = this._datumBlock.length;
        return headerSize;
    },
    ...
    write: function(data) {
        ...
        if (!_.isUndefined(data)) {
            ...
            if (this._blockOffset > this.syncInterval) {
                console.log("writing %d", this._blockOffset);
                this._writeBlock();
                this._resetBlocks();
            }
        }
