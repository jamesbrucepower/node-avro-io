...
_.extend(Block.prototype, {
    ...
    read: function(size) {
        ...
        if (size > this.remainingBytes) {
            return new AvroBlockError('tried to read(%d) past the amount written to the block(%d) at %d', 
...
_.extend(Reader.prototype, {
    ...
    _readHeader: function() {
        ...
        if (header instanceof Error || !header.magic || header.magic.toString() !== magic()) {
