...
DatumReader.prototype = {
    ...
    readEnum: function(writersSchema, readersSchema, decoder) {
        ...
        if (_.isObject(writersSchema)) {
            console.log(writersSchema);
            writersSchema = JSON.parse(writersSchema);
        }
    ...
    readRecord: function(writersSchema, readersSchema, decoder) {
        ...
        _.each(writersSchema.fields, function(field) {
            // TODO: fixme
            //console.log("record field is %s, type is %s (%s)",typeof(field), typeof(field.type), field.type);
            if (readersSchema)
