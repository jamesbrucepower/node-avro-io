...
DatumReader.prototype = {
    ...
    readData: function(writersSchema, readersSchema, decoder) {
        ...
        // The type RecordReferenceSchema's will be a record itself
        if (writersSchema.constructor.name === "RecordReferenceSchema" && writersSchema.type) {
            return this.readRecord(writersSchema.type, writersSchema.type, decoder);
        }
...
DatumWriter.prototype = {
    ...
    writeData: function(writersSchema, datum, encoder) {
        ...
        if (writersSchema.constructor.name === "RecordReferenceSchema" && writersSchema.type) {
            return this.writeRecord(writersSchema.type, datum, encoder);
        }
