...
DatumReader.prototype = {
    ...
    readData: function(writersSchema, readersSchema, decoder) {
        ...
        //console.log("output: %j", schema.type);
        switch(schema.type) {
            ...
            case "fixed":   return decoder.readFixed(schema.size); break;
    ...
    readUnion: function(writersSchema, readersSchema, decoder) {
        ...
        //console.log("schemaIndex is %d", schemaIndex);
    ...
    readRecord: function(writersSchema, readersSchema, decoder) {
        var self = this;
        var record = {};
        //console.log("record %s has %d fields", writersSchema.name, _.size(writersSchema.fields));
