...
BinaryDecoder.prototype = {
    ...
    readByte: function() {
        return this._input.readBytes(1);
    },
    ...
    readFloat: function() {
        return this._input.readBytes(4).readFloatLE(0);
    },

    readDouble: function() {
        return this._input.readBytes(8).readDoubleLE(0);
    },
	
    readFixed: function(len) {
        return this._input.readBytes(len);
    },
...
BinaryEncoder.prototype = {   
    ...
    writeLong: function(value) {
		// TODO: this currently assumes 64 bit architecture only
