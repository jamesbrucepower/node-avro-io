...
BinaryDecoder.prototype = {
    ...
    readByte: function() {
        return this._reader.readBytes(1);
    },
    ...
    readFloat: function() {
        return this._reader.readBytes(4).readFloatLE(0);
    },

    readDouble: function() {
        return this._reader.readBytes(8).readDoubleLE(0);
    },
...
BinaryEncoder.prototype = {   
    ...
    writeFloat: function(value) {
        ...
        this._writer.writeBytes(floatBuffer);
    },
    
    writeDouble: function (value) {
        var doubleBuffer = new Buffer(8);
        doubleBuffer.writeDoubleLE(value, 0);
        this._writer.writeBytes(doubleBuffer);
    },
    ...
    writeString: function(datum) {
        ...
        this.writeLong(size);
        this._writer.writeBytes(stringBuffer);
    }
