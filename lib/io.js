...
DatumReader.prototype = {
    ...
    readBlocks: function(decoder, lambda) {
        this._iterateBlocks(decoder, function() { decoder.readLong(); return -count; }, lambda);
    },
    
    skipBlocks: function(decoder, lambda) {
        this._iterateBlocks(decoder, function() { decoder.skipFixed(decoder.readLong()); return count; }, lambda);
    }
}
